...
// Variaveis Jogador 1
    ...
    int populacao1, pontosturisticos1, densidadepopulacional1;
   float area1, pib1, pibpercapita1;
...
// Variaveis Jogador 2
    ...
    int populacao2, pontosturisticos2, densidadepopulacional2;
    float area2, pib2, pibpercapita2;
